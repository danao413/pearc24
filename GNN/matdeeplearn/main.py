...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="CGCNN_demo, MPNN_demo, SchNet_demo, MEGNet_demo, GCN_demo, SOAP_demo, SM_demo, ALIGNN_demo GATGNN_demo",
    )
    parser.add_argument(
        "--seed",
        default=None,
    ...
    #add argument for random_split
    parser.add_argument('--random_split', default=None, type=str, help='randomly split data')
    #add argument for split index path
    parser.add_argument('--split_path', default=None, type=str, help='path with indices for splitting data')
    #add the error file name here
    parser.add_argument('--train_val_file', default=None, type=str, help='path to write the train/val error file per epoch')
    ...
    if args.train_val_file != None:
        config['Job']['train_val_file'] = args.train_val_file
    ...
    if args.random_split != None:
        config["Training"]['random_split'] = args.random_split
    if args.split_path != None:
        config['Training']['split_path'] = args.split_path
    ...
    if run_mode != "Hyperparameter":
        ...
        #this is where the dataset is, will have to split it into train/test/val
